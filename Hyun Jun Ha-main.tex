...
\begin{equation*}
    u_y(z) = \frac{\hat{u}_y(z)}{EI_x}\phi_0
\end{equation*}

\begin{equation*}
    u_y(z,s) = \frac{\hat{u}_y(z)}{I_x}sE_c^{-1}(s)\phi(s)
\end{equation*}
...
\begin{equation*}
    u_y(z,s) = \frac{z^4-2Lz^3+L^3z}{24I_x}sE_c^{-1}(s)(-\frac{3}{s}) = -\frac{z^4-2Lz^3+L^3z}{8I_x}E_c^{-1}(s)
\end{equation*}

\begin{equation*}
    u_y(z,t) = -\frac{z^4-2Lz^3+L^3z}{8I_x}E_c^{-1}(t)
\end{equation*}

\begin{equation*}
    u_y \big|_{max}(t) = -\frac{(\frac{L}{2})^4-2L(\frac{L}{2})^3+L^3(\frac{L}{2})}{8I_x}E_c^{-1}(t) = -\frac{5L^4}{128I_x}E_c^{-1}(t)
\end{equation*}

\begin{equation*}
    E_c^{-1}(t) = -\frac{128I_x}{5L^4} u_y \big|_{max}(t) = -\frac{128(\frac{1}{12})^4}{5(4)^4} u_y \big|_{max}(t) = -\frac{u_y \big|_{max}(t)}{207360}
\end{equation*}

\begin{equation*}
    J_\infty = -\frac{-\frac{1}{12}}{207360} = \frac{1}{2488320} ~psf^{-1}
\end{equation*}

\begin{equation*}
    \frac{1}{2488320} + (J_0 - \frac{1}{2488320})e^{-\frac{3600}{\tau_c}} = \frac{1}{3317760}
\end{equation*}

\begin{equation*}
    \frac{1}{2488320} + (J_0 - \frac{1}{2488320})e^{-\frac{1800}{\tau_c}} = \frac{1}{4147200}
\end{equation*}

\begin{equation*}
    J_0 =1.437 \times 10^{-7} ~psf^{-1}, ~\tau_c = 3829 ~s
\end{equation*}
